...
//Ehh assign lng ang 6 players sa NewPlayer... Automatic nana
...
//console.log(random);
       ...
       let NewPlayers = {id: socket.id, lifePoints: 10 ,name: socket.id, color: random.color, luck: 6, bet: 2000, img: random.img, LM: 0, dpotion: 2, leppot: 4, walletBal: 999}//Diri sila ibutang
